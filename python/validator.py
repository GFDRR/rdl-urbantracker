...
def validate_datasets():
    ...
    with open(config.datasets_input_csv_path, 'r', newline='') as f:
        ...
        with open(config.datasets_input_json_path, mode='w', encoding='utf-8') as jsonfile:
            for dataset in datasets:
                ...
                try:
                    ...
                    logging.error(f"Validation error for dataset {dataset_name} (id: {dataset_id}): {error_message}")
